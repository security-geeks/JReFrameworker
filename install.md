...
If you want to install from source for bleeding edge changes, follow the instructions at the [source](https://github.com/benjholla/JReFrameworker) repository.